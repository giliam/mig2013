...
\item une interface unique en ligne de commande constitue un blocage majeur pour la majorité des utilisateurs finaux et empêche une intégration large à des applications tierces.
\end{itemize}
...
Plus précisement dans le cadre des échanges entre le SpeechServer et les applications externes, les requêtes pourraient être traitées de la façon suivante :
...
\emph{L'architecture client/serveur proposée présenterait pour nous l'avantage de}
\begin{itemize}
...
\emph{L'architecture client/serveur proposée présenterait pour nos clients l'avantage de}
\begin{itemize}
...
comme des objets Python, avec le module pickle de la librairie standard.
...
On qualifie ce type de design de "Responsive".
