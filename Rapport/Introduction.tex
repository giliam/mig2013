...
Dans le cadre du projet \emph{Métiers de l'Ingénieur Généraliste - Systèmes embarqués} (projet d'enseignement en première année de l'école MINES ParisTech), nous nous sommes attaqués au sujet complexe et pluridisciplinaire du \og traitement automatique de la parole \fg.

Ce document décrit comment 13 élèves-ingénieurs en première année à MINES ParisTech, ne possédant pas de compétences a priori dans ce
