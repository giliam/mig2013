...
\og entraîne \fg l'automate à reconnaître un mot, plus il le reconnaîtra par la suite de manière fiable.
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Schéma récapitulatif du principe des modèles de Markov cachés}
\end{figure}
