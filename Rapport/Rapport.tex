...
De plus, il a fallu déterminer la valeur de nos constantes de découpe (coefficient de lissage, coefficient de coupe, intervalle de temps de sécurité), qui dépendent bien sûr les unes des autres. Ceci a été fait de manière empirique sur plusieurs enregistrements de mots différents, permettant une découpe automatique la plu satisfaisante possible pour l'ensemble des mots.
        \section{Echantillonnage, fenêtrage}
        	Nam eu sollicitudin\cite{ref1} massa. Duis sagittis velit mi. Nunc dictum risus ac interdum lacinia\cite{ref2}. Suspendisse ullamcorper ac dolor nec dapibus. 
        	...
        	\section{Mel}
        	Des études de psycho acoustique ont montré que l'oreille humaine ne percevait pas les fréquences selon une échelle linéaire. Il a donc été utile de définir une nouvelle échelle plus subjective : à chaque fréquence $f$, exprimée en Hertz, on fait correspondre une nouvelle fréquence selon une fonction censée représenter le comportement de l'oreille humaine. Par convention, la fréquence de $1000$ Hz correspond à $1000$ mel. Les autres fréquences mel sont ajustées de façon à ce qu'une augmentation de la fréquence mel corresponde à la même augmentation de la tonalité perçue. Cela conduit à la fonction $mel$ suivante: \begin{math}mel(f) = 2595*log(1+f/700)\end{math}
        	
        	\begin{figure}[hb]
						\begin{center}
							\includegraphics[width=14cm]{Images/Mel.png} 
						\end{center}
...
La concurrence importante nous oblige à être à la fois ambitieux et prudent. Nous avons donc décidé d'envisager à la fois la vente sur notre site internet d'un logiciel pour les particuliers, et de proposer des licences en parallèle, permettant notamment aux entreprises d'accéder à nos bases de données, les compléter et créer leurs propres dictionnaires.
				...
				\begin{table}[h]
				\centering
				\begin{tabular}{|c||p{1.7cm}|p{1.8cm}|p{1.7cm}|p{1.9cm}||p{1.7cm}|}
					\hline
					Catégorie/ & Salaire & Charges & Salaire & Charges & Budget \\
					Personnel & brut & salariales & net & patronales & \\
					\hline
					\hline
...
Ici nous avons pris le pari de vendre 50 000 versions du logiciel à un prix de 4,17\euro{} hors taxes, et une dizaine de licences permettant d'accéder à nos bases de données pour un prix de 833,33\euro{}. Au niveau des charges, l'ensemble des salaires cités plus haut est à prendre en compte, ainsi que le coût de notre campagne de publicité. Celle-ci peut être décrite en deux principaux pôles : des articles de journaux spécialisés, gratuits, et des annonces google. On peut estimer le prix d'une telle annonce à 10 centimes d'euros le clic. En estimant que 10\% des visiteurs du site par l'intermédiaire de l'annonce vont acheter le produit, on peut évaluer le coût de la publicité à 50 000\euro{}.

La différence des produits et des charges donne alors un chiffre de 164 423\euro{}.
				\begin{table}[h]
				\centering
					\begin{tabular}{|c||p{1.5cm}|p{1.6cm}|p{2cm}|p{1.2cm}|p{2cm}||p{2cm}||p{1.8cm}|}
						\hline
						& \multicolumn{5}{c|}{Produit} & \multicolumn{2}{c|}{Charges} \\
						\hline \hline
						& Vente & Prix unité (Hors taxes) & Prix unité TTC & Nombre & Total & Salaires & 45 777 \euro{} \\
						\hline \hline
						& Logiciel & 4,17 \euro{} & 5 \euro{} & 50000 & 250 200 \euro{} & Frais pub (google) & 50 000 \euro{} \\
						\hline
						& Licences & 833,33 \euro{} & 1 000 \euro{} & 10 & 10 000 \euro{} && \\
						\hline \hline
						Total & \multicolumn{7}{c|}{164 423 \euro{}} \\
						\hline
					\end{tabular}
				\caption{Compte de résultat provisionnel}
				\end{table}
				\section{Le bilan}
					\begin{table}[h]
						\centering
						...
						\hline
						\multicolumn{2}{c|}{Actifs} & \multicolumn{2}{c|}{Passif} \\
						\hline
						Actifs incorporels & 0,00 \euro{} & Fonds propres & 0,00 \euro{} \\
						\hline
						Créances & 0,00 \euro{} & Dettes long terme & Mines Paristech : 100 000\euro{} \\
						\hline
						Actifs immobiliers & 0,00 \euro{} & Compte de Résultat prévisionnel & 164 423,00 \euro{} \\
						\hline
...
Cette année, celle-ci n'a pas d'actif réel. Pas de trésorerie, de créances ou d'actifs immobiliers et incorporels. Son passif ne contient pas de fonds propres, et le compte de résultat prévisionnel a été explicité plus haut. On peut en revanche considérer que nous avons effectué un prêt à long terme à l'école des Mines de 100 000\euro{}, afin de financer les prémices du projet.
				\section{Les impôts}
					S'agissant des impôts, nous devons dans un premier temps reverser à l'Etat la TVA sur les produits que nous vendons, à un taux de 20\% à compter du 1\up{er} Janvier 2014. Le logiciel étant vendu 4,17\euro{} et la licence 833,33\euro{}, le total de la TVA à reverser sera de 52 040\euro{}.
Ensuite, l'impôt sur les sociétés est à un taux de 33\% sur les bénéfices. A partir du bilan et de la TVA, on peut estimer nos bénéfices à 112 383\euro{}, et donc un impôt sur les bénéfices à hauteur de 37 086\euro{}.
					\begin{table}[!h]
						\centering
						\begin{tabular}{|c|c|c|}
						\hline
						\multicolumn{3}{c|}{Impôts} \\
						\hline
						Sur les sociétés & 33\% des bénéfices & 37086,39 \euro{} \\
						\hline
						TVA & 20\% sur les ventes & 52 040,00 \euro{} \\
						\hline
						\end{tabular}
						\caption{Les impôts}
					\end{table}
				\section{Conclusion}
					Si nos produits fonctionnent aussi bien que nous l'espérons, l'entreprise sera viable. Mieux encore, en remboursant à taux nul le prêt de l'Ecole des Mines sur cinq ans, nous pouvons réinjecter dès l'an prochain 55 297\euro{} dans le projet afin de le rendre plus compétitif encore, et donc mieux le vendre.
