\nonewpagechapter{Analyse de la parole}
...
\begin{figure}[H]
	    \begin{center}
		    \includegraphics[width=8cm]{Images/oreille.png} 
	    \end{center}
...
\section{Enregistrement, recadrage, découpage et filtrage des signaux}
    \subsection{Synchronisation des enregistrements}
	...
	ce qui ne résout pas définitevement le problème, l'utilisateur ne pouvant pas toujours se placer dans ces conditions, le signal est traité par un filtre anti-bruit.
\begin{figure}[H]
    \begin{center}
...
\paragraph{}
    ...
    \subsection{Filtrage des signaux}
\paragraph{}
...
\end{figure}
\paragraph{}
	%Nous effectuons ce filtrage selon une méthode résolution basée sur les coefficients sceptraux de mel\cite{melbe}.
...
\paragraph{}
	...
	\section{Echantillonnage et fenêtrage des signaux}
...
\begin{figure}[H]
	    \begin{center}
		    \includegraphics[width=8cm]{Images/fenetrenormale.png} 
	    \end{center}
	    \caption{Principe normal du fenêtrage}
\end{figure}
\begin{figure}[H]
	    \begin{center}
		    \includegraphics[width=8cm]{Images/fenetrehann.png} 
	    \end{center}
...
\paragraph{}
	...
	au prix d'une multiplication du temps de calcul par deux.
        	...
        	\section{Passage des signaux dans le domaine des fréquences}
        	\paragraph{}
...
Il est préférable d'employer cette échelle de fréquence dans l'algorithme de reconnaissance: ce dernier doit en effet différencier plusieurs mots selon la perception humaine, c'est-à-dire en simulant le comportement de l'oreille humaine.
        	\section{Passage inverse des signaux dans le domaine temporel}
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=8cm]{Images/DCTschema.png} 
	\end{center}
	\caption{Graphe de conversion}
\end{figure}
\paragraph{}
