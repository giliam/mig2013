...
def mel_tab(list,pas):
	...
	list1[7]=tab_capture(list,pas,1136,1447)
	list1[8]=tab_capture(list,pas,1290,1603)
	list1[9]=tab_capture(list,pas,1447,1771)
	list1[10]=tab_capture(list,pas,1603,1932)
	list1[11]=tab_capture(list,pas,1771,2084)
	list1[12]=tab_capture(list,pas,1932,2249)
	list1[13]=tab_capture(list,pas,2084,2411)
	list1[14]=tab_capture(list,pas,2249,2569)
	list1[15]=tab_capture(list,pas,2411,2734)
	list1[16]=tab_capture(list,pas,2569,2889)
	list1[17]=tab_capture(list,pas,2734,3051)
	list1[18]=tab_capture(list,pas,2889,3210)
	list1[19]=tab_capture(list,pas,3051,3373)
	list1[20]=tab_capture(list,pas,3210,3535)
	list1[21]=tab_capture(list,pas,3373,3693)
	list1[22]=tab_capture(list,pas,3535,3855)
	list1[23]=tab_capture(list,pas,3693,4016)
	return(list1)
